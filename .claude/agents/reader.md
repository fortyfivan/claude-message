...
- **Skill criteria** — The skill definition used to generate the asset includes evaluation criteria. Cross-reference your review against those criteria.
...
- **Voice gate** — Cross-reference content against the voice gate rules (`.claude/skills/craft/voice/SKILL.md`). Flag banned phrases, structural anti-patterns, and AI-detectable cadence.
