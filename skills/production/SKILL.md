...
5. **Parse Content:** Validate the content file against the schema from `templates/content-schemas/`
...
The content file must follow the schema defined in `templates/content-schemas/[type].md`:
...
- **Standalone production:** `output/production/`
- **Campaign production:** `output/campaigns/[campaign-name]/production/`
