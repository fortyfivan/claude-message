...
- **Designed for the campaign agent.** Papers are anchor assets — the thing a digital campaign is built around. Blog posts reference them, emails CTA to them, social promotes them. Write knowing this asset will be the foundation other content builds on.
