...
[Instructions:
Full section sequence for this variant. The asset.md envelope no longer carries Structure for variant-likely assets — this section is the authoritative structural guide for the variant.
...
[Instructions:
Variant-specific CTA strategy — placement, link destination, button voice. CTAs vary by editorial intent: a use-case CTA usually drives to demo or peer reference; a thought-leadership CTA drives to newsletter signup or related anchor content; a product-announcement CTA drives to docs or pricing.
